...
@php
    $title = 'Clientes';
    $subTitle = 'Edite os contatos do cliente';
@endphp
        ...
        <div class="bg-white dark:bg-black overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('admin.contacts.update', $contact) }}" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-col items-center gap-6 w-full">
                        ...
                        <div class="flex justify-center">
                            <div class="relative group cursor-pointer w-40 h-40">
                                ...
                                @if ($contact->photo)
                                    <img id="preview-contact-photo-{{ $contact->id }}" src="{{ asset($contact->photo) }}"
                                        alt="Foto"
                        ...
                        {{-- Checkbox abaixo e centralizada --}}
                        <div class="mt-2">
                    ...
                    <div class="flex justify-center">
                        <button type="submit"
                            class="btn-mmcriativos rounded-md inline-flex items-center px-6 py-4">Salvar</button>
                    </div>
                </form>
            </div>
        </div>
