...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div>
        ...
        <input name="name" value="{{ old('name', $extra->name ?? '') }}"
            class="w-full appearance-none bg-white dark:bg-dark-700 border border-gray-300 dark:border-dark-600 text-gray-800 dark:text-gray-200 rounded px-3 py-2 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150"
            required />
    </div>
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="description" rows="3"
            class="w-full appearance-none bg-white dark:bg-dark-700 border border-gray-300 dark:border-dark-600 text-gray-800 dark:text-gray-200 rounded px-3 py-2 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150">{{ old('description', $extra->description ?? '') }}</textarea>
    </div>
