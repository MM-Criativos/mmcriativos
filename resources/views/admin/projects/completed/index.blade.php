    ...
    <div class="card h-full p-0 rounded-xl overflow-hidden border-0">
        <div class="card-header border-b border-neutral-200 dark:border-neutral-600 pb-0 pt-0 px-0">
            <div class="px-6 py-6 flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-neutral-900 dark:text-white">Concluídos</h2>
                    <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Veja os projetos finalizados e revise ou
                        apague quando quiser.</p>
                </div>
                <a href="{{ route('admin.projects.create') }}"
                    class="inline-flex items-center px-6 py-3 rounded btn-mmcriativos">
                    Adicionar Projeto
                </a>
            </div>
        </div>
        <div class="card-body p-6">
            @if ($projects->isEmpty())
                <p class="text-gray-600 dark:text-gray-300">Nenhum projeto concluído.</p>
            @else
                            ...
                            <div class="py-4 px-6 flex-1 flex flex-col justify-between">
                                ...
                                <div class="flex items-center justify-between mt-auto">
                                    <a href="{{ route('admin.projects.steps.show', ['project' => $project, 'tab' => 'delivery']) }}"
                                        class="btn-mmcriativos inline-flex items-center gap-1 px-5 py-3 rounded">
