                            ...
                            <div class="py-4 px-6 flex-1 flex flex-col justify-between">
                                ...
                                <div class="flex items-center justify-between mt-auto">
                                    <a href="{{ route('admin.projects.steps.show', ['project' => $project, 'tab' => 'delivery']) }}"
                                        class="inline-flex items-center gap-1 px-5 py-3 bg-orange-600 text-white rounded border border-transparent hover:bg-white hover:text-orange-600 hover:border-orange-600 transition-colors text-sm">
