<div class="mt-6">
    ...
    <div class="mb-4 flex items-center justify-between">
        ...
        <button form="form-update-all"
            ...
            <i class="fa-solid fa-rotate-right mr-1"></i> Atualizar todos
        </button>
    </div>
                    ...
                    <div class="grid grid-cols-12 gap-3 items-end">
                        ...
                        <div class="col-span-3">
                            ...
                            <input type="text" name="challenges[{{ $challenge->id }}][title]"
                                value="{{ $challenge->title }}" class="w-full border-gray-300 rounded-md text-sm"
                                required>
                        </div>
                        ...
                        <div class="col-span-8">
                            ...
                            <input type="text" name="challenges[{{ $challenge->id }}][description]"
                                value="{{ $challenge->description }}" class="w-full border-gray-300 rounded-md text-sm">
                        </div>

                        {{-- 🔹 Excluir --}}
                        <div class="col-span-1 flex items-end justify-end">
                            <button type="button"
                                class="js-delete inline-flex items-center justify-center w-full px-4 py-3 bg-red-600 text-white rounded hover:bg-red-700 text-sm"
        ...
        <div class="grid grid-cols-12 gap-3 items-end">
            <div class="col-span-3">
                ...
                <input type="text" name="title" class="w-full border-gray-300 rounded-md text-sm"
                    placeholder="Novo desafio" required>
            </div>
            <div class="col-span-8">
                <label class="block text-sm font-medium text-gray-700 mb-1">Descrição</label>
