                    ...
                    <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="file" name="thumb" accept="image/*" class="mt-1 block w-full border-gray-300 rounded-md" onchange="previewImg(event, '#thumbPreview')">
                                <img id="thumbPreview" class="mt-2 h-32 rounded object-cover hidden" alt="preview">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Cover</label>
                                <input type="file" name="cover" accept="image/*" class="mt-1 block w-full border-gray-300 rounded-md" onchange="previewImg(event, '#coverPreview')">
                                <img id="coverPreview" class="mt-2 h-32 rounded object-cover hidden" alt="preview">
                            </div>
                        </div>
