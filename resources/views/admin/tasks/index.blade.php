    ...
    <x-slot name="header">
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Acompanhe as entregas planejadas e organize o que ainda falta concluir.
                </p>
            </div>
            ...
            <div class="space-y-4">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-5 shadow-sm" x-data="{ open: false }">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <div class="flex flex-col items-end gap-2 text-sm text-gray-600">
                                ...
                                <div class="text-right">
                                    ...
                                    @if ($task->planned_at && $task->planned_at->isPast())
                                        <span
                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                            ...
                            <div>
                                ...
                                <p>{{ optional($task->updated_at)->format('d/m/Y H:i') ?? 'Sem registro' }}</p>
                            </div>
                ...
                @empty
                    <div class="bg-white border border-dashed border-gray-300 rounded-lg p-6 text-center text-gray-500">
                        Nenhuma tarefa pendente encontrada com os filtros atuais.
                    </div>
                @endforelse
            </div>
