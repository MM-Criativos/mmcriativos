            ...
            <div class="col-lg-6 wow fadeInLeft animated" data-wow-delay="200ms">
                <div class="contact-one__left">
                    <div class="section-title">
                        <h5 class="section-title__tagline section-title__tagline--has-dots">Toda grande ideia começa com uma conversa</h5>
                    ...
                    <div class="contact-one__form-box">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="contact-one__input-box">
                                        <input type="text" placeholder="Seu nome" name="name" value="{{ old('name') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="contact-one__input-box">
                                ...
                                <div class="col-md-6">
                                    <div class="contact-one__input-box">
                                        <input type="text" placeholder="WhatsApp" name="whatsapp" value="{{ old('whatsapp') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="contact-one__input-box">
                        ...
                        @endif
                        @if (session('status'))
                            <div class="mt-3 p-3 bg-green-100 text-green-800 rounded">{{ session('status') }}</div>
                        @endif
                    </div>
                </div>
            </div>
