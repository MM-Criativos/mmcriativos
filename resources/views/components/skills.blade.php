    ...
    <div class="container">
        <div class="ogency-owl__dots ogency-owl__carousel owl-theme owl-carousel"
            ...
            <div class="item">
                <div class="service-three__item">
                    <div class="service-three__item__thumb">
                        <img src="assets/images/service/services-3-1.jpg" alt="ogency" />
                    </div><!-- /.service-image -->
                    <div class="service-three__item__normal">
                        <h3 class="service-three__item__normal__title">Layout e Interface</h3>
            ...
            <div class="item">
                <div class="service-three__item">
                    <div class="service-three__item__thumb">
                        <img src="assets/images/service/services-3-2.jpg" alt="ogency" />
                    </div><!-- /.service-image -->
                    <div class="service-three__item__normal">
                        <h3 class="service-three__item__normal__title">Estrutura e Lógica</h3>
                    </div><!-- /.service-normal-content -->
                    <div class="service-three__item__hover">
                        <h3 class="service-three__item__hover__title">
            ...
            <div class="item">
                <div class="service-three__item">
                    <div class="service-three__item__thumb">
                        <img src="assets/images/service/services-3-3.jpg" alt="ogency" />
                    </div><!-- /.service-image -->
                    <div class="service-three__item__normal">
                        <h3 class="service-three__item__normal__title">Experiência do Usuário</h3>
                    </div><!-- /.service-normal-content -->
                    <div class="service-three__item__hover">
                        <h3 class="service-three__item__hover__title">
            ...
            <div class="item">
                <div class="service-three__item">
                    <div class="service-three__item__thumb">
                        <img src="assets/images/service/services-3-4.jpg" alt="ogency" />
                    </div><!-- /.service-image -->
                    <div class="service-three__item__normal">
                        <h3 class="service-three__item__normal__title">SEO e Desempenho</h3>
                    </div><!-- /.service-normal-content -->
                    <div class="service-three__item__hover">
                        <h3 class="service-three__item__hover__title">
            ...
            <div class="item">
                <div class="service-three__item">
                    ...
                    <div class="service-three__item__normal">
                        <h3 class="service-three__item__normal__title">Automação e Integração</h3>
                    </div><!-- /.service-normal-content -->
                    <div class="service-three__item__hover">
                        <h3 class="service-three__item__hover__title">
