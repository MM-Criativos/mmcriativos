@component('mail::message')
    ...
    Muito obrigado por compartilhar suas percepções no formulário anterior! Agora, para deixar tudo ainda mais alinhado com
    suas necessidades, temos algumas perguntas mais específicas.
