...
<div class="px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-sm">
            ...
            {{-- Tabs --}}
            <div class="px-6 pt-4 border-b border-neutral-200 dark:border-neutral-800 flex gap-0" id="tabs">
                <button type="button" class="tab-btn tab-active px-4 py-2.5 text-sm font-medium border-b-2 border-[#ff8800] text-[#ff8800]" data-tab="form">
                    Dados &amp; Features
                </button>
                <button type="button" class="tab-btn px-4 py-2.5 text-sm font-medium border-b-2 border-transparent text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 transition-colors" data-tab="tenants">
                    Tenants
                    <span class="ml-1.5 text-xs bg-neutral-100 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-300 rounded-full px-1.5 py-0.5">{{ count($assignedTenants) }}</span>
                </button>
            </div>
            ...
            {{-- ── TAB: Dados & Features ──────────────────────────────── --}}
            <div id="tab-form" class="tab-panel px-6 pb-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            @foreach([
                                ...
                                ['logo_icon',    'Ícone (sidebar mínimo)','png,jpg,jpeg,svg,webp', 'logo_icon_url',    'Quando sidebar está fechado'],
